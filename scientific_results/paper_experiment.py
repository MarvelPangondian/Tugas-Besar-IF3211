...
def generate_paper_plots(experiment_results):
    ...
    plt.tight_layout()
    plt.savefig("./scientific_results/all_results/paper_figure1_scenarios.png", dpi=300, bbox_inches="tight")
    ...
    plt.tight_layout()
    plt.savefig("./scientific_results/all_results/paper_figure2_thresholds.png", dpi=300, bbox_inches="tight")
    ...
    plt.tight_layout()
    plt.savefig("./scientific_results/all_results/paper_figure3_spatial.png", dpi=300, bbox_inches="tight")
...
def main():
    ...
    with open("./scientific_results/all_results/paper_statistics.json", "w") as f:
